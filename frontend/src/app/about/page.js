        ...
        <div className="bg-[url('/temp-background-image-low.webp')] bg-cover bg-center">
            ...
            <section className="text-gray-600 body-font">
                <p className="text-gray-500 mb-3">
                    <Link href="/" className="text-indigo-500 underline">Home</Link> &gt; <Link href="/about" className="text-indigo-500 underline">About</Link>
                </p>
            </section>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-white bg-opacity-70 p-8 rounded-lg shadow-md">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-950">About Rental Roulette</h1>
