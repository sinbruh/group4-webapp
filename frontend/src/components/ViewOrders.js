...
export default function ViewOrders({ rental }) {
    ...
    const ordersForCurrentPage = orders.slice((currentPage - 1) * entriesPerPage, currentPage * entriesPerPage);

    return (
        <div className="max-w-7xl mx-auto p-6 bg-white shadow-md rounded-md flex flex-col h-[80vh] overflow-auto">
